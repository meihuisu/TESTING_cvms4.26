function newUrl() {
  var datagroup=document.getElementById("dataGroup").value;
  var datatype=document.getElementById("dataType").value;

  var newurl= "data/"+datagroup+"_po_all_"+datatype+".csv";
  return newurl;
}
...
function addLinesPlot(divname, configs, fwidth, fheight) {
  ...
  var ctrace=makeCompareDataTraces(pdata,'PO-MODEL-0 & PO-UCVM-0',1,0,6);
